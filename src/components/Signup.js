...
const Signup = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password === cpassword) {
      const response = await fetch(`http://3.110.210.52/api/auth/createuser`, {
        method: "POST",
        headers: {
      ...
      <Card sx={{ maxWidth: 525, mx: 'auto', textAlign: 'center', backgroundColor: '#415A77', borderRadius: 7 }}>
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
            ...
            <div>
              <label htmlFor="cpassword" className="sr-only">Re-enter Password</label>
            ...
            <div className="flex items-center justify-between">
              <button type="submit" className="inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white"> Sign Up </button>
            </div>
          </form>
        </CardContent>
      </Card>

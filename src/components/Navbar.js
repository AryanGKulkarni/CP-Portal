    ...
    <header className="w-full bg-gray-800 text-gray-100 body-font mb-4 shadow-sm">
      ...
      <div className="container mx-auto flex justify-between items-center py-7 px-5">
        ...
        <a href="/" className="flex flex-shrink-0 title-font font-medium items-center text-gray-900 md:mb-0">
          <span className="ml-3 text-xl text-gray-100 font-semibold antialiased">CP Portal</span>
        </a>
        {/* Navbar */}
        <nav className="hidden md:ml-auto md:flex flex-wrap items-center justify-center text-base tracking-wide">
          <a href="/Problemset" className="mr-8 hover:text-gray-300">Problems</a>
          <a href="/UpcomingContests" className="mr-8 hover:text-gray-300">Upcoming Contests</a>
        ...
        <div className="hidden sm:inline-flex ml-auto md:ml-0 mr-4 md:mr-0 cursor-pointer">
          <a href="/UserProfile"><svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
